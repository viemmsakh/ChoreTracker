...
CREATE DATABASE hendtlpg_chores_db WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE = 'en_US.UTF-8';
...
CREATE TABLE public.adopt (
    ...
    intended character varying NOT NULL,
    generated timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
